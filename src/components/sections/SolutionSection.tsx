      ...
      >
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="border border-border/50 rounded-2xl bg-zinc-900/80 backdrop-blur-sm shadow-2xl overflow-hidden glow-hover">
              <div className="bg-zinc-800/80 px-4 py-3 border-b border-border/50 flex items-center gap-3">
              ...
              <div className="p-4 space-y-4 h-[400px] overflow-y-auto bg-[url('https://img.usecurling.com/p/800/600?q=pattern&color=black&dpr=1')] bg-cover bg-center bg-blend-overlay bg-black/40">
